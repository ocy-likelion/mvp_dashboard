...
def upgrade() -> None:
    ...
    op.create_table('user_last_checks',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_table('unchecked_descriptions',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('content', sa.Text(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('training_course', sa.String(length=255), nullable=True),
    ...
    op.create_table('unchecked_comments',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    sa.Column('username', sa.String(length=255), nullable=True),
    sa.Column('created_by', sa.String(length=100), nullable=True),
    sa.ForeignKeyConstraint(['unchecked_id'], ['unchecked_descriptions.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
