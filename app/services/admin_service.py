...
class AdminService(BaseService):
    ...
    def get_daily_task_status(
        ...
        for course in training_courses:
            ...
            check_rate = AdminService.calculate_check_rate(total_tasks, checked_tasks)
    ...
    @staticmethod
    def validate_date_filter(date_str: str = None) -> datetime:
        """날짜 필터 검증"""
        if date_str is None:
    ...
    def get_training_courses_summary(session: Session) -> List[Dict]:
        ...
        for course in training_courses:
            ...
            completion_rate = AdminService.calculate_check_rate(
