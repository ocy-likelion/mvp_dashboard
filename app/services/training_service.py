...
class TrainingService(BaseService):
    ...
    def update_training_info(
        session: Session, training_id: int, update_data: Dict
    ) -> TrainingInfo:
        """훈련 과정 정보 수정"""
    ...
    @staticmethod
    def delete_training_info(session: Session, training_id: int) -> None:
        """훈련 과정 정보 삭제"""
        training = TrainingService.safe_get_by_id(
            session, TrainingInfo, training_id, "훈련 과정을 찾을 수 없습니다."
        )
    ...
    @staticmethod
    def get_upcoming_training_courses(
    ...
    @staticmethod
    def get_completed_training_courses(
